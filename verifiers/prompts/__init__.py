...
from .smola_templates import SMOLA_TOOL_PROMPT_TEMPLATE
from .smola_few_shots import SMOLA_CALCULATOR_FEW_SHOT, SMOLA_SEARCH_FEW_SHOT
...
__all__ = [
    ...
    "SMOLA_TOOL_PROMPT_TEMPLATE", "SMOLA_CALCULATOR_FEW_SHOT",
